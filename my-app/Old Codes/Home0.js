            ...
            <div className="flex h-screen">
                ...
                <div className="flex-1 flex flex-col bg-white p-8 overflow-auto">
                    <div className="flex justify-between items-center mb-8">
                        <button className="bg-blue-500 text-white py-2 px-6 rounded shadow-md">+ Add new</button>
                        <div className="flex">
                    ...
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        {tasks.length > 0 ? (
                            tasks.map((task, index) => (
                                <div key={index} className="p-4 grid grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-6 items-center border-b">
                                    ...
                                    <span className="text-green-500 font-semibold">New task</span>
                        ...
                        <div className="p-4">
                            <p className="text-blue-500 font-semibold cursor-pointer">+ Add task</p>
                        </div>
                    </div>
