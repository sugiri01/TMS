            ...
            <div className="flex h-screen">
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
                    <div className="bg-white p-8 rounded shadow-lg w-1/2">
                        ...
                        <div className="flex justify-end space-x-4 mt-4">
                            <button onClick={() => setIsTeamModalOpen(false)} className="bg-gray-400 text-white py-2 px-4 rounded">
                                Cancel
                            </button>
                            <button onClick={handleCreateTeam} className="bg-blue-500 text-white py-2 px-4 rounded">
                                Create Team
                            </button>
                        </div>
                    </div>
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
                    <div className="bg-white p-8 rounded shadow-lg w-1/2">
                        ...
                        <div className="flex justify-end space-x-4 mt-4">
                            <button onClick={() => setIsProjectModalOpen(false)} className="bg-gray-400 text-white py-2 px-4 rounded">
                                Cancel
                            </button>
                            <button onClick={handleCreateProject} className="bg-blue-500 text-white py-2 px-4 rounded">
                                Create Project
                            </button>
                        </div>
                    </div>
